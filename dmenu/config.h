...
static const char *colors[SchemeLast][2] = {
    /*   fg         bg    */
    /*   fg         bg    */
    [SchemeNorm] =          { "#fb4934", "#222222" },
    [SchemeSel] =           { "#fbf1c7", "#928374" },
    [SchemeSelHighlight] =  { "#fabd2f", "#282a36" },
    [SchemeNormHighlight] = { "#fbf1c7", "#282a36" },
    [SchemeOut] =           { "#000000", "#928374" },
    [SchemeMid] =           { "#928374", "#282a36" }, 
